...
defmodule Common.Constant do
  ...
  ## 订单类型
  define(order_type_recharge, 1)
  define(order_type_vio_ticket, 2)
  define(order_type_inspection, 3)

  ########### 用户相关 ##########

  ## 用户种类
  define(mobile_user, 1)
  define(alipay_user, 2)
  define(wechat_user, 3)
  ...
  ########### 电子眼错误码 ########
  define(err_unknown, 90011)
  define(err_carno, 90016)
  define(err_vin, 90017)
  define(err_engine, 90018)
  define(err_car_type, 90019)
  define(err_unsupport, 90020)
end
